...
public class RunnerTest {
    ...
    public static void main(String[] args) {
        ...
        Article article5 = new Article(journalist2, "Big Daddy Kane scores first UK #1", "The Scottish Gangsta Rap' star celebrated as hit record 'Not a Statement' topped the charts", "War with Russia is about to begin after Boris Johnson called Vladimir Putin a 'chicken' who doesnt have the 'balls' to go to war with the UK", CategoryType.UK, "https://avatars3.githubusercontent.com/u/31411380?s=460&v=4");
